                ...
                <div className=" mx-auto px-4 py-28 2xl:gap-[350px] text-text_color overflow-hidden md:px-8 md:flex">
                  <div className="flex-none space-y-5 2xl:max-w-5xl 2xl:mt-[30px] max-w-3xl">
                    ...
                    <h1
                      style={{
                        fontFamily:
                          i18n.language === "ar" ? "Cairo, sans-serif" : "", // Default font when language is not Arabic
                      }}
                      className="mx-auto max-w-8xl font-display text-[30px]  lg:text-5xl md:text-5xl  font-[600] tracking-tight text-text_color"
                    >
                      <span className="inline-block">
                        {t("header")}{" "}
                        <span className="text-transparent bg-clip-text h-[60px] 2xl:block bg-primary">
                          {" "}
                          {t("the_Future")}{" "}
                        </span>{" "}
