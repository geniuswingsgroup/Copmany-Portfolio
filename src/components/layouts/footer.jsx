            ...
            Wings
              ...
              <div className="flex flex-col gap-9 mt-[50px]">
                ...
                <li className="flex items-center text-text_color  justify-center gap-2 lg:justify-start">
                  ...
                  Kasernen str. 12 , 21073 Hamburg / Germany                </li>
              </div>
            </div>
            <div className="lg:mx-auto text-center sm:text-left">
              <h4 className="text-lg text-text_color  font-medium mb-7">Company</h4>
              <ul className="text-md transition-all duration-500">
                <li className="mb-6"><Link to={'/'} className="text-sub_text  hover:text-primary">Home</Link></li>
                <li className="mb-6"><Link to={'/Courses'} className="text-sub_text  hover:text-primary">Courses</Link></li>
                <li className="mb-6"><Link to={'/Our-Projects'} className="text-sub_text  hover:text-primary">Projects</Link></li>
              </ul>
            </div>
            <div className="lg:mx-auto text-center sm:text-left">
              <h4 className="text-lg text-text_color font-medium mb-7">Support</h4>
              <ul className="text-md transition-all duration-500">
                <li className="mb-6"><Link to={'/About-us'} className="text-sub_text  hover:text-primary">About us</Link></li>
                <li className="mb-6"><Link to={'/Contact-us'} className="text-sub_text  hover:text-primary">Contact Us</Link></li>
              </ul>
            </div>
            <div className="lg:mx-auto text-center sm:text-left">
              <h4 className="text-lg text-text_color font-medium mb-7">Social Media</h4>
              <ul className="text-md transition-all duration-500">
                <li className="mb-6"><a target='blank' href='https://www.instagram.com/gwg2025?igsh=eHV3NTgycjZ1NWV2' className="text-sub_text  hover:text-primary">Instagram</a></li>
                <li className="mb-6"><Link target='blank'   onClick={handleWhatsAppClick}  className="text-sub_text  hover:text-primary">WhatsApp</Link></li>
              </ul>
            </div>
          </div>
        </div>
