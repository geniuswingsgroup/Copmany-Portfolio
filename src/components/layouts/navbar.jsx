...
import home from "../../Locale/home-page.json";
  ...
  const Brand = () => (
    <div className="flex items-center justify-between py-2 Navbar-responsive:block">
      ...
      >
        <img
          src={brand}
          className="md:h-[57px] sm:mt-[-16px]  mt-[-13px] small-screen:h-[40px] h-[30px]"
          alt="Message Shield"
        />
        <h2
          style={{
            fontFamily: "Cairo, sans-serif", // Default font when language is not Arabic
          }}
          className="md:text-[25px] small-screen:text-[15px]  text-[13px]  mt-0.5  font-[500] text-text_color leading-[3.25rem]"
        >
          Genius
    ...
    >
      ...
      >
        ...
        <h2
          ...
          className="md:text-[25px] text-[17px] mt-2  font-[500] text-text_color leading-[3.25rem]"
        >
          Genius
          <span className="text-transparent bg-clip-text bg-primary">
            Wings
