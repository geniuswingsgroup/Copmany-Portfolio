            ...
            <div className="w-full mx-auto">
              <div className="w-full justify-start items-center gap-12 grid lg:grid-cols-2 grid-cols-1">
                ...
                >
                  <div className="w-full flex-col justify-center items-start gap-8 flex">
                    ...
                    <div className="w-full lg:justify-start justify-center items-center sm:gap-10 gap-5 inline-flex">
                      <div className="flex-col justify-start items-start inline-flex">
                        <h3 className="text-text_color text-4xl font-bold font-manrope leading-normal">
                          5+
                        </h3>
                        <h6 className="text-sub_text text-base font-normal leading-relaxed">
                          {t("features_Experience")}{" "}
                        </h6>
                      </div>
                      <div className="flex-col justify-start items-start inline-flex">
                        <h4 className="text-text_color text-4xl font-bold font-manrope leading-normal">
                          10+
                        </h4>
                        <h6 className="text-sub_text text-base font-normal leading-relaxed">
                  ...
                  <Link
                    to={"/Our-features"}
                    className="sm:w-fit w-full px-3.5 py-2 bg-primary hover:bg-hover active:bg-active transition-all duration-700 ease-in-out rounded-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex"
                  >
