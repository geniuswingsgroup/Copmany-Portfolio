...
const CourseDetails = () => {
  ...
  return (
    ...
    className="flex flex-col bg-background_color justify-between min-h-screen">
<Helmet>
  {/* Basic Meta Tags */}
  ...
  <script type="application/ld+json">
    ...
    `}
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:w-1/2 px-4">
              ...
              <div className="flex gap-1 items-center">
                <h3 className="text-lg text-text_color font-semibold ">{t("Lecturer")}   :</h3>
              ...
              <div className="flex gap-1 items-center text-text_color  mb-4">
                <h3 className="text-lg font-semibold ">{t("Start_Date")} :</h3>
                <div className="flex space-x-2 text-sub_text ">
      ...
      >
        <h2    dir={i18n.language === "ar" ? "rtl" : "ltr"}   style={{
      
      fontFamily: i18n.language === 'ar' ? 'Cairo, sans-serif' : '', // Default font when language is not Arabic
    }} className="text-2xl text-text_color font-bold mb-4">{t("Register_for_Course")}</h2>
        <form   dir={i18n.language === "ar" ? "rtl" : "ltr"}    style={{
