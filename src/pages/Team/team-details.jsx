...
const TeamDetails = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen justify-between md:pt-7 pt-11 bg-[#1e1e1e]">
      <Helmet>
        {/* Basic Meta Tags */}
        <title>{`${
          details ? details.name : "Team Member"
        } - Genius Wings Company`}</title>
        <meta
          name="description"
          content={`${
            details
              ? `${details.name}, ${details.job_title} at Genius Wings Company. Learn more about their experience, skills, and role at our company.`
              : "Team member details at Genius Wings Company"
          }`}
        />
        <meta
          name="keywords"
          content={`${
            details
              ? `${details.name}, ${details.job_title}, team member, Genius Wings Company, professional details, experience, role`
              : "team member, Genius Wings Company, about team"
          }`}
        />
        ...
        <meta
          ...
          content={`${
            details ? details.name : "Team Member"
          } - Genius Wings Company`}
        />
        <meta
          property="og:description"
          content={`${
            details
              ? `${details.name} is a ${details.job_title} at Genius Wings Company, with expertise in ${details.experience} years of experience.`
              : "Meet our talented team members at Genius Wings Company."
          }`}
        />
        <meta
          property="og:image"
          content={
            details
              ? details.image
              : "http://genius-wings.com/images/Brand-Logo.png"
          }
        />
        <meta
          property="og:url"
          content={`http://genius-wings.com/team-details/${id}`}
        />
        ...
        <meta
          ...
          content={`${
            details
              ? `${details.name} is a ${details.job_title} with ${details.experience} years of experience in the field.`
              : "Meet our talented team members at Genius Wings Company."
          }`}
        />
        <meta
        ...
        <link
          rel="canonical"
          href={`http://genius-wings.com/team-details/${id}`}
        />
          ...
          {`
      {
        ...
        "description": "${
          details
            ? details.description
            : "Learn more about our team at Genius Wings Company."
        }",
          ...
          <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
            ...
            <div className="mt-[50px] rounded-lg ">
              ...
              <div className="flex flex-col mt-[-10px] mb-[30px]">
                ...
                <dd className="text-md break-words text-sub_text font-[500]">
                  {details.description}
                </dd>
              </div>
            </div>
