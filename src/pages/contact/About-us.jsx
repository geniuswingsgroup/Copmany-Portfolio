...
const About_us = () => {
  ...
  className="flex flex-col justify-between bg-[#1e1e1e] min-h-screen">
      <Helmet>
  {/* Basic Meta Tags */}
              ...
              <div className="container mx-auto">
                <div className="lg:flex lg:-mx-6">
                  ...
                  <div className="mt-8 lg:w-2/4 lg:mt-0 lg:px-6">
                    ...
                    <div>
                      <h3 className="text-transparent bg-clip-text bg-primary capitalize">
                      {t("Expert_Development_Team_Title")}                       </h3>
                      <p className="block mt-2 font-medium text-sub_text  ">
                    ...
                    <div>
                      <h3 className="text-transparent bg-clip-text bg-primary capitalize">
                      {t("Client_Centered_Approach_Title")}                      </h3>
                    ...
                    <div>
                      <h3 className="text-transparent bg-clip-text bg-primary capitalize">
    {t("Commitment_to_Excellence_Title")}                         </h3>
                      <p className="block mt-2 font-medium text-sub_text ">
